            ...
            `;
                ...
                try {
                    ...
                    const response = await fetch(
                        `http://localhost/entre-lineas/api/get-full.php?titulo=${encodeURIComponent(valor)}`
                    );
...
async function cargarCategorias() {
    ...
    const response = await fetch(
        "http://localhost/entre-lineas/api/get-full-categorias.php"
    );
...
async function cargarAutores() {
    ...
    const response = await fetch(
        "http://localhost/entre-lineas/api/get-full-autores.php"
    );
...
buscarBtn.addEventListener("click", async () => {
    ...
    if (tipo === "titulo") {
        ...
        url =
            `http://localhost/entre-lineas/api/get-full.php?titulo=${encodeURIComponent(titulo)}`;
    ...
    // CATEGORIA
        ...
        url =
            `http://localhost/entre-lineas/api/get-full-categorias.php?id_categoria=${categoria}`;
    ...
    // AUTOR
        ...
        url =
            `http://localhost/entre-lineas/api/get-full-autores.php?id_autor=${autor}`;
    ...
    // FECHAS
        ...
        url =
            `http://localhost/entre-lineas/api/get-full-fechas.php?fecha_inicio=${inicio}&fecha_fin=${fin}`;
    ...
    noticiasPagina.forEach((noticia, index) => {
        ...
        resultados.innerHTML += `
            ...
            <article class="card">
                ...
                <a
                    href="/entre-lineas/top-top-top/${noticia.slug}"
                    class="btn ${button}"
                >
                    Leer más
                </a>
